...
const BiayaDanJadwal = (props) => {
    ...
    const gelombang = props.gelombang;
                    ...
                    <div className="col-md-12 mt-3">
                        <div className="card shadow">
                            <div className="card-body p-4 text-center">
                                    ...
                                    <hr /><br />
                                    <p>Saat ini pendaftaran Masih belum dibuka atau sudah ditutup. Silahkan hubungi admin untuk informasi terkait. Terimakasih</p>
                                    {/* <p>{props.gelombang.nama_gelombang}</p>
                                    <hr />
                                    <br />
                                    <h1><b>{biaya}</b></h1>
